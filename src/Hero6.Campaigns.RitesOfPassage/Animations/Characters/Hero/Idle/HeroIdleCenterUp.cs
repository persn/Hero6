// <copyright file="HeroIdleCenterUp.cs" company="Late Start Studio">
...
namespace LateStartStudio.Hero6.Campaigns.RitesOfPassage.Animations.Characters.Hero.Idle
{
    ...
    public class HeroIdleCenterUp : AnimationModule
    {
        ...
        public override string Sprite => "Campaigns/Rites of Albion/Animations/Characters/Hero/Idle/Center Up";
